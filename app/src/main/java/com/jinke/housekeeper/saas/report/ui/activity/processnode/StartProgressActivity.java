...
import com.jinke.housekeeper.ui.widget.CustomPopWindows;
...
public class StartProgressActivity extends BaseActivity<DelayProgressActivityView, DelayProgressActivityPresenter> implements
    ...
    private void initAdapter() {
        ...
        dealpeople.setText(objBeanDetail.getHandUserName());
        tv_checkdetails_end.setText(nodeInfosBean.getTime());
        tv_checkdetails_Signed.setText(bean.getTime());
        tv_checkdetails_problem.setVisibility(View.VISIBLE);
        tv_checkdetails_problem.setText("抢单成功");
        ...
        switch (v.getId()) {
            ...
            case R.id.callPhone:  //电话被点击
                ...
                if (ContextCompat.checkSelfPermission(this, Manifest.permission.CALL_PHONE)
                    ...
                    if (objBeanDetail.getHandUserName() != null || objBeanDetail.getHandUserName().toString().trim() != "") {
                        titleContent.setText("是否拨打" + objBeanDetail.getHandUserName() + "的电话？");
            ...
            case R.id.sureDelete:
                if (objBeanDetail == null && objBeanDetail.getHandUserPhone() == null) {
                    ToastUtils.showShort("联系人暂未留取电话号码");
                    return;
                }
                String phoneNum = "tel:" + objBeanDetail.getHandUserPhone().toString().trim();
    ...
    public void getProcessDetailOnError(String code, String msg) {
        ...
        CommonlyUtils.errorState(MyApplicaption.getInstance(), code);
    }
